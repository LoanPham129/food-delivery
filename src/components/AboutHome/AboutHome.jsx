  ...
  return (
    ...
    >
      <div className="absolute top-0 left-0 w-full h-full opacity-10 pointer-events-none">
        <div className="absolute top-1/4 left-20 w96\ h-96 bg-amber-400/20 rounded-full blur-3xl mix-blend-soft-light">
          <div className="absolute bottom-0 right-0 w-80 h-80 bg-orange-600/15 blur-3xl rounded-full mix-blend-soft-light"></div>
        </div>
      </div>
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center lg:gap-8 xl:gap-16 relative">
        <div className="w-full order-1 lg:order-2 space-y-8 sm:space-y-12 relative">
          ...
          <p className="text-base sm:text-lg md:text-left opacity-90 leading-relaxed max-w-3xl font-serif italic bg-amber-500/60 pl-4 sm:pl-6 py-2 bg-gradient-to-r from-white/5 to-transparent">
          ...
          <div className="flex flex-wrap gap-4 items-center mt-6 sm:mt-8 px-4 sm:px-0">
            <Link
              to="/about"
              className="px-4 sm:px-6 py-2 sm:py3 bg-gradient-to-r from-amber-500 to-orange-600 rounded-xl font-bold hover:scale-[1.02]
                transition-transform duration-300 flex items-center gap-2 sm:gap-4 shadow-xl hover:shadow-amber-500/20 group relative overflow-hidden"
            >
              ...
              <FaInfoCircle className="text-lg sm:texl animate-pulse" />
        ...
        <div className="w-full order-2 lg:order-1 md:max-w-md lg:max-w-none lg:w-7/12 mt-12 mb-10 lg:mb-0 relative group transform hover:scale-[1.01] transition-all duration-500">
          <div className="relative rounded-[4rem] outline-hidden border-4 border-amber-900/30 hover:border-amber-600/40 transition-all duration-500 shadow-2xl shadow-black/50">
            ...
            <div className="absolute -bottom-12 left-1/2 -translate-x-1/2 w-4/5 h16 bg-amber-900/30 blur-3xl z-0"></div>
          </div>

          <div className="absolute -top-6 -right-6 w-24 bg-amber-500/10 rounded-full blur-xl"/>
        </div>
      </div>
