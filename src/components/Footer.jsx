...
const Footer = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    alert(`Thanks for subcribing! We'llsend updates to ${email}`);
    setEmail("");
  };

  return (
    <footer className="bg-[#2a211c] text-amber-100 py-12 px-4 sm:px-6 lg:px-8 relative outline-hidden">
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 mb-12">
          ...
          <div className="space-y-6">
            ...
            <form onSubmit={handleSubmit} className="realtive mt-4 group">
              ...
              <div className="relative">
                ...
                <button
                  type="submit"
                  className="absolute right-1 top-1 bg-gradient-to-br from-amber-300 via-orange-500 to-amber-600 text-white px-4 py-2 
                  rounded-full flex items-center gap-1.5 shadow-lg hover:shadow-amber-400/30 overflow-hidden transition-all duration-500"
                >
                  ...
                  <span
                    className="absolute inset-0 -translate-x-full bg-gradient-to-r from-transparent via-amber-50/30 to-transparent 
                ...
                {navItems.map((i) => (
                  <li key={i.name}>
                    ...
                    >
                      ...
                      <span className="hover:italic">{i.name}</span>
                    </a>
                  </li>
                ))}
              </ul>
              ...
              <div className="flex space-x-4">
                {socialIcons.map(
                  ...
                  duration-300 relative group"
                      style={{ color }}
                    >
                      <Icon className=" hover:scale-125 transition-transform"></Icon>
        ...
        {/* bottom section */}
        <div className=" border-t border-amber-800 pt8 mt8 text-center justify-center">
