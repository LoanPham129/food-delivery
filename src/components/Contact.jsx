...
const Contact = () => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        console.log('form submitted: ', formFata)
    ...
    const handleChange = (e) => setFormData({...formFata, [e.target.name]: e.target.value})
  return (
    <div
    ...
    >
      ...
      <div className=" absolute top-20 left-10 w24 gap-24 bg-orange-500/20 rounded-full animate-float" />
      <div className=" absolute bottom-40 right-20 w-16 h-16 bg-gray-500/20 rounded-full animate-float-delayed" />
      <div className=" max-w-7xl mx-auto relative z-10">
        ...
        <div className=" grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            <div
              className=" relative bg-white/5 backdrop-blur-lg rounded-2xl p-6 shadow-2xl transform transition-all group duration-300 
            hover:scale-[1.02] animate-card-float bottom-1-4 border-amber-500 hover:border-amber-400"
            >
              <div
                className=" absolute inset-0 bg-gradient-to-r from-amber-500/10 to-transparent opacity-0 group-hover:opacity-100 duration-300 
              rounded-2xl"
              />
            ...
            <div
              className=" relative bg-white/5 backdrop-blur-lg rounded-2xl p-6 shadow-2xl transform transition-all group duration-300 
            hover:scale-[1.02] animate-card-float bottom-1-4 border-green-500 hover:border-green-400"
            >
              <div
            ...
            <div className=" relative bg-white/5 backdrop-blur-lg rounded-2xl p-6 shadow-2xl transform transition-all group duration-300 hover:scale-[1.02] animate-card-float bottom-1-4 border-orange-500 hover:border-orange-400">
              <div className=" absolute inset-0 bg-gradient-to-r from-orange-500/10 to-transparent opacity-0 group-hover:opacity-100 duration-300 rounded-2xl transition-opacity" />
              <div className=" flex items-center mb-4 relative z-10">
          ...
          {/* contact form */}
          <div className=" relative bg-white/5 backdrop-blur-lg rounded-2xl p-6 shadow-2xl animate-slided-in-right border-2 border-amber-500/30 hover:border-amber-500/50 transform-border duration-300">
