...
import { FaHeart, FaStar, FaFire, FaPlus } from "react-icons/fa";
    ...
    <div className="bg-gradient-to-b from-[#1a1212] to-[#2a1e1e] text-white py-16 px-4 font-[Poppins]">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-14">
          <h1
            className="text-5xl font-bold m-4 transform transition-all bg-gradient-to-r from-amber-400 to-red-500 bg-clip-text 
          ...
          {(showAll ? initialData : initialData.slice(0, 4)).map(
            (item, index) => {
              ...
              return (
                <div
                  key={`${item.id}-${index}`}
                  className="relative group bg-[#4b3b3b] rounded-3xl overflow-hidden shadow-2xl 
                  ...
                  <div className="relative h-72 overflow-hidden">
                    ...
                    <div className="absolute bottom-4 left-4 right-4 flex justify-between items-center bg-black/40 backdrop-blur-sm px-4 py-2 rounded-full">
                      <span className="flex items-center gap-2 text-amber-400">
                        <FaStar className="text-xl drop-shadow-[0_2px_2px_rgba(0,0,0,0.80]" />
                    ...
                    <div className="flex items-center justify-between gap-4">
                      ...
                      {cartItem ? (
                        <div className="flex items-center gap-3">
                          ...
                          <span className="w-8 text-center to-amber-100 font-cinzel">
                            {" "}
                            {quantity}
                          </span>
                          <button
        ...
        <div className="mt-12 flex justify-center">
          <button
            ...
            className="flex items-center gap-3 bg-gradient-to-r from-red-700 to-amber-700 text-white px-8 py-4 rounded-2xl font-bold txlg text-lg uppercase tracking-wider hover:gap-4 hover:scale-105 hover: shadow-xl
