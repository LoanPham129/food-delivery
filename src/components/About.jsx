    ...
    >
      ...
      >
        <div className=" max-w-4xl mx-auto">
          <motion.h1
            className=" text-5xl sm:text-6xl md:text-7xl font-bold mb-4 font-serif bg-clip-text text-transparent bg-gradient-to-r
        ...
        <div className=" max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 md:gap-12">
          {features.map((f, i) => {
            ...
            return (
              ...
              >
                <div
                  className=" absolute -inset-1 bg-gradient-to-br from-amber-600/30 to-amber-500/30 rounded-3xl blur-lg opacity-50 
      ...
      <section className=" py-16 px-4 md:px-8 bg-gradient-to-br from-[#1a120b] to-[#3c2a21]/90">
        <div className=" max-w-7xl mx-auto grid grid-cols-1 sm:from-cyan-200 md:grid-cols-4 gap-8">
          {stats.map((s, i) => {
            const Icon = s.icon;
            return (
              <motion.div
              ...
              >
                ...
                >
                  <div
                    className="relative h-full bg-[#3c2a21]/40 backdrop-blur-lg rounded-xl border-2 border-amber-600/30 p-6 overflow-hidden 
                  ...
                  >
                    ...
                    <div className=" relative z-10  h-full flex flex-col items-center justify-center">
                      ...
                      >
                        <Icon className=" w-8 h-8 text-amber-50/90" />
                      </motion.div>
                  ...
                  <motion.div
                    className=" absolute insetx-x-4 bottom0 h-8 bg-amber-900/30 blur-xl rounded-full"
                    animate={{
      ...
      <section className=" py-16 px-4 md:px-8 relative">
        <div className=" max-w-7xl mx-auto">
          <motion.h2
            ...
            whileInView={{ opacity: 1, y: 0 }}
            className="text-4xl font-serif sm:text-5xl md:text-6xl font-bold 
  text-center mb-12 text-amber-100"
          >
            Meet Our <span className="text-amber-500">Culinary Artist</span>
          </motion.h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 lg:gap-12">
            {teamMembers.map((m, i) => (
              <motion.div
                ...
                className=" relative h-full bg-[#3c2a21]/90 backdrop-blur-lg rounded-3xl overflow-hidden border-2 
  border-amber-600/30 hover:border-amber-500 transition-all duration-500 shadow-xl hover:shadow-2xl hover:shadow-amber-500"
              >
                <div className=" relative h64 sm:h-72 md:h-96 overflow-hidden">
                  <motion.img
                    src={m.img}
                    alt={m.name}
                    className=" w-full h-full object-cover"
                ...
                <div className=" p-8 text-center flex flex-col h-[cal(100%-24rem)]">
                  <div className="mb-4">
                    ...
                    <p className=" text-amber-500 tlg font-medium font-cursive">
                      {m.role}
                    </p>
                  </div>
                  <p className=" text-amber-100/80 txlg font-cursive flex-grow">
                    {m.bio}
                  </p>
                  <motion.div
